...
CONCEPT.PARTICIPANT.AGE_AT_EVENT='PARTICIPANT|AGE_AT_EVENT'
CONCEPT.PARTICIPANT.VISIT_NUMBER='PARTICIPANT|VISIT_NUMBER'
CONCEPT.PARTICIPANT.AGE = 'PARTICIPANT|AGE'                     # Actually just year of birth
CONCEPT.PARTICIPANT.YEAR_OF_BIRTH = 'PARTICIPANT|YEAR_OF_BIRTH'    
...
class MEASUREMENT(PropertyMixin):
    NAME = None
    CODE = None
    DERIVED_FROM = None
    ALT_CODES = None
...
constants.COMMON.NOT_ASSESSED = 'Not Assessed'
